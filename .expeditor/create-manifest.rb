...
def get_latest(channel, origin, name)
  ...
  pinned_hab_components = {
    "hab"          => { "origin" => "core", "name" => "hab",          "version" => "0.81.0", "release" => "20190507225645"},
    "hab-sup"      => { "origin" => "core", "name" => "hab-sup",      "version" => "0.81.0", "release" => "20190507232554"},
    "hab-launcher" => { "origin" => "core", "name" => "hab-launcher", "version" => "11055",   "release" => "20190507223943"}
  }
